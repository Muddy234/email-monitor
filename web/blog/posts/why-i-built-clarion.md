...
1. Read every thread. Every CC, every loop-in, every forward. Read it, not topic-classify it.
2. Tell me what matters. Who's waiting on me, what got asked, what got decided, what changed since the last time I looked.
3. Draft, but don't send. Get me 80% of the way to a reply in my own voice, so I'm editing instead of staring at a blank box.
